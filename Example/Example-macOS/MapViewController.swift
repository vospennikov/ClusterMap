...
final class MapViewController: NSViewController {
    ...
    private lazy var clusterManagerDelegate = ClusteredMapManagerDelegate()
...
@objc private extension MapViewController {
    func addActionHandler(_ sender: NSButton) {
        let annotations = dataSource.makeRandomAnnotations(count: 10_000, within: mapView.region)
