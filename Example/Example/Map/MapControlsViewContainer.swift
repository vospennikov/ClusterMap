...
private extension MapControlsViewController {
    ...
    func buildAnnotationTypesControl() -> UIView {
        let segmentControl = UISegmentedControl(items: AnnotationTypes.allCases.map { $0.description })
...
// MARK: - Preview
struct MapControlsViewController_PreviewProvider: PreviewProvider {
