...
open class ClusterAnnotationView: MKAnnotationView {
    ...
    override open func prepareForDisplay() {
    ...
    /// This method sets the text of the `countLabel` to the count of annotations in the provided `ClusterAnnotation`,
    /// and updates the view's layout to accommodate the label.
    ...
    open func configure(_ annotation: ClusterAnnotation) {
        ...
        /// This property sets the background color of the view by updating its underlying layer's backgroundColor
        /// property.
        open var backgroundColor: NativeColor? {
            get {
                guard let nativeLayer,
                      let backgroundColor = nativeLayer.backgroundColor
                else {
                    return nil
                }
